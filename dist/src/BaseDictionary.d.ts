 ...
 */
export declare class BaseDictionary<K, V> implements IDictionary<K, V> {
    private _iDict;
    private _length;
    private _iCounter;
    private _iKeyIndex;
   ...
   */
     ...
     */
    addRange(values: BaseDictionary<K, V>): void;
    /**
 ...
 */
    ...
    */
     ...
     */
    getRange(keys: K[]): BaseDictionary<K, V>;
    /**
 * Copies the Dictionary to a new Dictionary using the specified keys
 * @param keys Keys to use for the new Dictionary
 */
    getRange(keys: List<K>): BaseDictionary<K, V>;
    /**
     * Copies the whole Dictionary to a new Dictionary
     */
    getRange(): BaseDictionary<K, V>;
    /**
     ...
     */
    getRangeByValues(values: V[]): BaseDictionary<K, V>;
    /**
     * Copies the Dictionary to a new Dictionary using the specified values. All occurrences will be transferred to the new Dictionary
     * @param values Values to use for the new Dictionary
     */
    getRangeByValues(values: List<V>): BaseDictionary<K, V>;
    /**
